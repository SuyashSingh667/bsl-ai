...
const STRINGS: Record<SupportedLanguage, Record<string, string>> = {
  hi: {
    ...
    suspectedButton: '⚠️ संदिग्ध खतरा / नियर-मिस',
    ...
    dialectNotice: '⚠️ क्षेत्रीय भाषा प्रोटोटाइप: तकनीकी इस्पात संयंत्र शब्दावली की सटीकता बोकारो फील्ड कर्मियों के साथ परीक्षण योग्य है।',
  ...
  en: {
    ...
    suspectedButton: '⚠️ Suspected Hazard / Near-Miss',
    ...
    dialectNotice: '⚠️ Regional Language Scaffolding: Dialect accuracy for heavy metallurgy jargon requires on-site validation with Bokaro shift workers.',
  ...
  bn: {
    ...
    suspectedButton: '⚠️ সন্দেহজনক বিপদ / নিয়ার-মিস',
    ...
    dialectNotice: '⚠️ আঞ্চলিক ভাষা যাচাইকরণ: ইস্পাত কারখানার আঞ্চলিক প্রযুক্তিগত পরিভাষার নির্ভুলতা বোকারো শিফট কর্মীদের সাথে মাঠপর্যায়ে পরীক্ষা প্রয়োজন।',
  ...
  or: {
    ...
    suspectedButton: '⚠️ ସନ୍ଦିଗ୍ଧ ବିପଦ / ନିୟର-ମିସ୍',
    ...
    dialectNotice: '⚠️ ଆଞ୍ଚଳିକ ଭାଷା ପ୍ରମାଣୀକରଣ: ଇସ୍ପାତ କାରଖାନାର ବୈଷୟିକ ଶବ୍ଦାବଳୀ ପାଇଁ ବୋକାରୋ ଶିଫ୍ଟ କର୍ମଚାରୀଙ୍କ ସହିତ କ୍ଷେତ୍ରସ୍ତରୀୟ ପରୀକ୍ଷା ଆବଶ୍ୟକ।',
